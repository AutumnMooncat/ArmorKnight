...
import ArmorKnight.util.CardArtRoller;
...
import static ArmorKnight.MainModfile.makeImagePath;
import static ArmorKnight.MainModfile.modID;
import static ArmorKnight.util.Wiz.atb;
import static ArmorKnight.util.Wiz.att;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, TheArmorKnight.Enums.ARMORED_MAUVE_COLOR);
    }
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target, final CardColor color) {
        ...
        FlavorText.AbstractCardFlavorFields.boxColor.set(this, mix(BLACK.cpy(), MainModfile.ARMORED_MAUVE_COLOR.cpy()));
