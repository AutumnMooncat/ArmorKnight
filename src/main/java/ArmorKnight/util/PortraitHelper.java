...
public class PortraitHelper {
    ...
    private static final Texture attackMask = TexLoader.getTexture("ArmorKnightResources/images/masks/AttackMask.png");
    private static final Texture skillMask = TexLoader.getTexture("ArmorKnightResources/images/masks/SkillMask.png");
    private static final Texture powerMask = TexLoader.getTexture("ArmorKnightResources/images/masks/PowerMask.png");
