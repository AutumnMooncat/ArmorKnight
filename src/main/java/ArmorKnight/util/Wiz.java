...
import ArmorKnight.actions.TimedVFXAction;
import ArmorKnight.patches.CardCounterPatches;
import ArmorKnight.powers.DivineForcePower;
import ArmorKnight.powers.LosePowerPower;
import ArmorKnight.powers.NextTurnPowerPower;
...
public class Wiz {
    ...
    public static boolean isInKnightRun() {
        return CardCrawlGame.isInARun() && AbstractDungeon.player instanceof TheArmorKnight;
    }
}
