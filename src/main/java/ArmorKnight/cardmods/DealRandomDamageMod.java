...
import ArmorKnight.actions.InfusionTriggerAction;
import ArmorKnight.cards.cardvars.DynvarInterfaceManager;
        ...
        Wiz.atb(new AbstractGameAction() {
            ...
            public void update() {
                ...
                if (mon!= null) {
                    ...
                    Wiz.att(new InfusionTriggerAction(DealRandomDamageMod.this, damage, baseVal == relicStatsVal ? damage : damage - ArmorKnight.util.CalcHelper.calculateCardDamage(baseVal - relicStatsVal, mon)));
                }
                this.isDone = true;
            }
        });
